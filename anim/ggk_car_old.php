...
import { OrbitControls } from '../js/OrbitControls_res.js';
...
import { FontLoader } from '../js/FontLoader_res.js';
import { TextGeometry } from '../js/TextGeometry_res.js'
*/
...
*/
	...
	// Edifício Evelyn, Rua Girassol, 594 Apto. 502, CEP: 05433-001
...
window.addEventListener("keydown",function(e){
	...
	if(keysArray[i]==83){teclaV=1;}//V Pilot Trás
	if(keysArray[i]==38){teclaW=1;}//W Frente
	if(keysArray[i]==40){teclaV=1;}//V Pilot Trás
...
window.addEventListener('keyup',function(e){
	...
	if(getNumberArray(keys)[i]==83){teclaV=1;}//V Pilot Trás
	if(getNumberArray(keys)[i]==38){teclaW=1;}//W Frente
	if(getNumberArray(keys)[i]==40){teclaV=1;}//V Pilot Trás
